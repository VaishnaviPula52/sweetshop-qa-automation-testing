...
export class BasketPage {
  ...
  constructor(page: Page) {
    ...
    this.collectOption  = page.locator('label:has-text("Collect"), #exampleRadios1');
    this.shippingOption = page.locator('label:has-text("Standard Shipping"), #exampleRadios2');
    this.promoInput     = page.locator('input[placeholder*="Promo"], input[placeholder*="promo"], input[id*="promo"]');
